...
public sealed record EdcInterval(long Start, List<EdcIntervalProducer> Producers, List<EdcIntervalConsumer> Consumers, double SumProduction, double SumSharing, double SumMissed);
...
public sealed record EdcLinkInterval(long Start, List<EdcLinkValue> Links);
